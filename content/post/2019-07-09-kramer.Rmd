...
The data shows that **no one** in America named their child Daenerys before show's debut in 2011. By 2016, more than 100 families were choosing the name Daenerys. The memes are coming to life! ![](/post/2019-07-09-kramer_files/Danny Meme.png)
...
Even though Phoebe missed the cut, the data shows that Friends has transformed Phoebe into a moderately popular name when compared to it's past frequency. 
...
I then figured that Creed must have been a very popular name sometime in the past and it is *just now* coming back into style.
<br/>
